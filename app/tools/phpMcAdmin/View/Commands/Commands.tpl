        ...
        <div class="container corner full-size padding">
            <table>
                <tr valign="top">
                    ...
                    <td class="padding" style="border-left:1px solid #ffffff;padding-left:14px;">
                    <span class="red">Warning !</span><br/>This thing is only for <span class="red">debuging issue, do not use it in a production environment as it can lock
                    or impact your memcached servers performances.</span>
